...
function Hero({}: Props) {
	return (
		...
		>
			<div className={`${styles.flexStart} flex-1 flex-col sm:px-16 px-6 xl:px-0`}>
				<div className={`${styles.flexCenter} bg-black-gradient rounded-[10px] mb-2 px-4 py-[6px]`}>
					<img
						src={discount}
						alt="discount"
				...
				<div className="flex flex-row justify-between items-center w-full">
					...
					<div className="hidden ss:flex md:ml-4 ml-0">
						<GetStarted />
					</div>
				</div>
