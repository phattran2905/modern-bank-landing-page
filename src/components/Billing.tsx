	...
	return (
		...
		>
			<div className={`${layout.sectionImgReverse}`}>
				...
				<div className="absolute z-[3] -left-1/2 w-[50%] h-[50%] top-0 rounded-full white__gradient"></div>
        ...
        <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          ...
          <img src={google} alt="google_play" className="w-[128px] h-[128px] object-contain mr-5 cursor-pointer" />
        </div>
			</div>
		</section>
	);
